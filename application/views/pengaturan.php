...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/css/dropzone.min.css" type="text/css" rel="stylesheet" />
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url() ?>index.php/dashboard/pengaturan"><i class="si si-settings"></i><span class="sidebar-mini-hide">Pengaturan</span></a>
                                </li>
                            </ul>
                        </div>
                        <!-- END Side Navigation -->
                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <form action="<?php echo base_url() ?>index.php/dashboard/update" onsubmit="return confirm('Yakin ingin mengubah password anda?')" method="post">
                                <!-- <div class="col-md-6 form-group">
                                    <label for="example-nf-password">Password lama</label>
                                    <input type="password" class="form-control" id="update-password_lama" name="password_lama" value="<?php echo set_value('password_lama'); ?>" placeholder="Ketik password lama anda" 
                                    <small class="text-danger"><?=form_error('password_conf')?></small>
                                </div> -->
                                <div class="col-md-6 form-group">
                                    <label for="example-nf-password">Password baru</label>
                                    <input type="password" class="form-control" id="update-password" name="password_conf" value="<?php echo set_value('password_conf'); ?>" placeholder="Masukkan password baru anda" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="example-nf-password">Ulangi password baru</label>
                                    <input type="password" class="form-control" id="update-password_conf" name="password" value="<?php echo set_value('password'); ?>" placeholder="Ketik ulang password baru anda" required matches[password_conf]>
                                </div>
                                <div class="col-md-6 form-group">
                                    <div>

...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Pengajuan Sertifikasi | PERDAMI | Resertifikasi Dokter Spesialis Mata</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-inverse main-content-boxed">
            ...
            <main id="main-container">
                ...
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Form Pengajuan Sertifikasi</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <a href="<?php echo base_url() ?>index.php/dashboard/kelompok1_form_tab1">
                                <div class="block">
                                    <div class="block-content">
                                        <div class="pull-left">
                                            <img src="<?php echo base_url() ?>assets/media/ic_kelompok1.png" style="margin-right:30px;">
                                        </div>
                                        <div style="margin-left: 95px;">
                                            <h5>Kelompok 1</h5>
                                            <p class="text-muted">Dokter spesialis mata lulusan IPDS yang telah memasukkan fakoemulsifikasi ke dalam Kurikulum Pendidikan Sp1-nya, dan telah dinyatakan lulus fakoemulsifikasi.<br/>
                                            Dokter spesialis mata yang telah menyelesaikan pelatihan fakoemulsifikasi dari institusi yang telah terekognisi KOI</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="<?php echo base_url() ?>index.php/dashboard/kelompok2_form_tab1">
                                <div class="block">
                                    <div class="block-content">
                                        <div class="pull-left">
                                            <img src="<?php echo base_url() ?>assets/media/ic_kelompok2.png" style="margin-right:30px;">
                                        </div>
                                        <div style="margin-left: 95px;">
                                            <h5>Kelompok 2</h5>
                                            <p class="text-muted">Dokter spesialis mata yang tidak termasuk ke dalam kelompok 1</p>
                                        </div>
                                    </div>
                                </div>
                            </a>

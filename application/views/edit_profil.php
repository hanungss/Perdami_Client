...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Edit Profil | PERDAMI | Resertifikasi Dokter Spesialis Mata</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-inverse main-content-boxed">
            ...
            <main id="main-container">
                ...
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Edit Profil</h2>
                    <div class="block">
                                        ...
                                        <div class="block-content block-content-full clearfix">
                                            <div class="text-left">
                                                ...
                                                <?php
                                                    ...
                                                    <?php echo form_open_multipart('dashboard/edit_user');?>
                                                    <li>
                                                        <div class="form-material floating">
                                                            <input type="text" class="form-control" id="signup-nama" name="nama_user" value="<?=set_value('nama_user')?>">
                                                            <label for="signup-no">Nama anda : <?php echo $row->nama_user; ?></label>
                                                            <small class="text-danger"><?=form_error('nama_user')?></small>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-material floating">
                                                            <input type="number" class="form-control" id="signup-no-anggota" name="no_anggota" value="<?=set_value('no_anggota')?>">
                                                            <label for="signup-no">No Anggota : <?php echo $row->no_anggota; ?></label>
                                                            <small class="text-danger"><?=form_error('no_anggota')?></small>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-material floating">
                                                            <input type="number" class="form-control" id="signup-no-hp" name="no_hp" value="<?=set_value('no_hp')?>">
                                                            <label for="signup-no">No Telp. : <?php echo $row->no_hp; ?></label>
                                                            <small class="text-danger"><?=form_error('no_hp')?></small>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-material floating">
                                                            <input type="email" class="form-control" id="signup-email" name="email" value="<?=set_value('email')?>">
                                                            <label for="signup-no">Email : <?php echo $row->email; ?></label>
                                                            <small class="text-danger"><?=form_error('email')?></small>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-material floating">
                                                            <input type="text" class="form-control" id="signup-cabang" name="cabang" value="<?=set_value('cabang')?>">
                                                            <label for="signup-no">Cabang Perdami : <?php echo $row->cabang; ?></label>
                                                            <small class="text-danger"><?=form_error('cabang')?></small>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-material floating">
                                                            <input type="text" class="form-control" id="signup-instansi" name="instansi" value="<?=set_value('instansi')?>">
                                                            <label for="signup-no">Instansi kerja : <?php echo $row->instansi; ?></label>
                                                            <small class="text-danger"><?=form_error('instansi')?></small>
                                                        </div>
                                                    </li>
                                                     <li>
                                                        <div class="form-material floating">
                                                            <input type="file" class="form-control" id="signup-foto" name="foto" value="<?=set_value('foto')?>">
                                                            <label for="signup-no"></label>
                                                            <small class="text-danger"><?=form_error('foto')?></small>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-material floating">
                                                             <button type="submit" value="upload" name="submit" class="js-swal-success btn btn-success" ><i class="fa fa-upload mr-10"></i> Simpan</button>
                                                        </div>
                                                    </li>
                                                </ul>
                                             <?php } else { ?>
                                            <h3>Data gagal di update</h3>
                                            <?php } ?>
                                            </div>
                                            <?php echo form_close();?> 
                                        </div>

...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Form Pengajuan Sertifikasi Kelompok 1 | PERDAMI | Resertifikasi Dokter Spesialis Mata</title>
    ...
    <body>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    <nav class="breadcrumb bg-white push">
                        ...
                        <span class="breadcrumb-item active">Form pengajuan sertifikasi (Kelompok 1)</span>
                    </nav>
                    <h2 class="content-heading" style="padding-top: 15px;">Form pengajuan sertifikasi (Kelompok 1)</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Progress Wizard -->
                            <div class="js-wizard-simple block">
                                ...
                                <ul class="nav nav-tabs nav-tabs-block nav-fill" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#wizard-progress-step1" data-toggle="tab">Sertifikat kompetensi lama</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#wizard-progress-step2" data-toggle="tab">Ijazah</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#wizard-progress-step3" data-toggle="tab">Rekomendasi KADEP</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#wizard-progress-step4" data-toggle="tab">Konfirmasi kebenaran data</a>
                                    </li>
                                </ul>
                                <!-- END Step Tabs -->
        ...
        <!-- Javascript -->
        <!-- refresh otomatis tabel -->
        <script>
           $(document).ready(function() {
               $("#tabel-sertifikat").load("<?php echo base_url() ?>index.php/dashboard/tabel_sertifikat");
               var refreshId = setInterval(function() {
                  $("#tabel-sertifikat").load('<?php echo base_url() ?>index.php/dashboard/tabel_sertifikat?randval='+ Math.random());
              }, 1000);
       ...
       <script>
           $(document).ready(function() {
               $("#tabel-ijazah").load("<?php echo base_url() ?>index.php/dashboard/tabel_ijazah");
               var refreshId = setInterval(function() {
                  $("#tabel-ijazah").load('<?php echo base_url() ?>index.php/dashboard/tabel_ijazah?randval='+ Math.random());
              }, 1000);
               $.ajaxSetup({ cache: false });
           });
       </script>
       <script>
           $(document).ready(function() {
               $("#tabel-kadep").load("<?php echo base_url() ?>index.php/dashboard/tabel_kadep");
               var refreshId = setInterval(function() {
                  $("#tabel-kadep").load('<?php echo base_url() ?>index.php/dashboard/tabel_kadep?randval='+ Math.random());
              }, 1000);
               $.ajaxSetup({ cache: false });
           });
       </script>
       <!-- end refresh tabel otomatis -->
        <script>
            Dropzone.autoDiscover = false;

            var file_upload= new Dropzone(".dropzone",{
                url: "<?php echo base_url('index.php/dashboard/proses_upload_1') ?>",
                maxFilesize: 10,
                method:"post",
            ...
            var file_upload_kadep= new Dropzone("#dropzone_ijazah",{
                url: "<?php echo base_url('index.php/dashboard/proses_upload_2') ?>",
                maxFilesize: 10,
                method:"post",
                acceptedFiles:"application/pdf,.psd,.doc,.docx,.jpg,.jpeg,.png",
                paramName:"userfile",
            ...
            var file_upload_kadep= new Dropzone("#dropzone_kadep",{
                url: "<?php echo base_url('index.php/dashboard/proses_upload_3') ?>",
                maxFilesize: 10,
                method:"post",
                acceptedFiles:"application/pdf,.psd,.doc,.docx,.jpg,.jpeg,.png",
                paramName:"userfile",
            ...
            $.ajax({
            type:"post",
            url:"<?php echo base_url('index.php/dashboard/remove_file') ?>",
            cache:false,
            dataType: 'json',
            success: function(){
